        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApproveEmergencyContact = table.Column<bool>(type: "bit", nullable: true),
                    ...
                    ApproveNextOfKin = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsentLetterStatus = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsentLetters", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "GaurantorAccounts",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProfileId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Appoved = table.Column<bool>(type: "bit", nullable: false),
                    GaurantorSigned = table.Column<bool>(type: "bit", nullable: false),
                    GaurantorId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    GurantorStatus = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GaurantorAccounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GaurantorAccounts_AspNetUsers_GaurantorId",
                        column: x => x.GaurantorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GaurantorAccounts_AspNetUsers_ProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Loans_AspNetUsers_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LoanPaymentHistories_Loans_LoanId",
                        column: x => x.LoanId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GaurantorAccounts_GaurantorId",
                table: "GaurantorAccounts",
                column: "GaurantorId");

            migrationBuilder.CreateIndex(
                name: "IX_GaurantorAccounts_ProfileId",
                table: "GaurantorAccounts",
                column: "ProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_LoanPaymentHistories_LoanId",
